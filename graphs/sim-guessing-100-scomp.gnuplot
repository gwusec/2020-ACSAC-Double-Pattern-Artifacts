...
plot "../res/scomp/control.txt" w lp lw 2 lt 8 dt 1 pt 5 ps 0.5 pi 5 t "Control DPatt", \
     "../res/scomp/first.txt" w lp lw 2 lt 4 dt 4 pt 6 ps 0.5 pi 5 t "BL-first DPatt", \
     "../res/scomp/both.txt" w lp lw 2 lt 3 dt 3 pt 8 ps 0.5 pi 5 t "BL-both DPatt", \
